<?php
	...
	function orderpage(){
		add_menu_page('Ingenico Order','Ingenico Order','manage_options', 'ingenico-order','check_order');
	}
...
?>
	...
	<html lang="en">
		...
		<body>
			<div class="container">
				<div class="row">
					<div class="text"><h1>Ingenico Orders</h1></div>
						...
						<tbody>
							...
							foreach($results as $row){
								...
								<tr>
									...
									<td><?php echo $row->ingenico_identifier; ?></td>
									...
									<?php if ( $row->response !== "" && $row->status !== "User Aborted") {?>
										...
										'<?php echo $row->ingenico_identifier; ?>',
										'<?php echo $date[0]; ?>',
